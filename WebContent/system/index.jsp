  ...
  <div>
    <h3 class="steptitle">Current Building Block Configuration:</h3>
        <bbNG:contentList>
            ...
            <bbNG:contentListItem title="${bundle['page.system.admin.step1.apiservername.label']}"><code><%=b2Context.getSetting(API_SERVER_NAME)%></code></bbNG:contentListItem>
   	...
   	<script type="text/javascript">
     	...
     	jQuery(document).ready(function(){
			...
			jQuery("#testStatus").ajaxError( function(xhr, ajaxOptions, thrownError) { 
	    	 ...
	    	 var load_url = "test.jsp?url=<%=b2Context.getSetting(API_SERVER_NAME)%>/?apiKey=<%=b2Context.getSetting(API_KEY)%>";
